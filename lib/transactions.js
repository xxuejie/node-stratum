...
exports.CreateGenerationPOS = function(rpcData, publicKey, extraNoncePlaceholder){
    ...
    var p1 = Buffer.concat([
        ...
        binpack.packUInt32(rpcData.curtime, 'little'),
        util.varIntBuffer(1),
...
exports.CreateGenerationPOW = function(rpcData, publicKey, extraNoncePlaceholder){
